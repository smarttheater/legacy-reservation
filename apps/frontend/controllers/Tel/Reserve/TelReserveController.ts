...
export default class TelReserveController extends ReserveBaseController {
    ...
    public start(): void {
        ...
        reservationModel.purchaserGroup = ReservationUtil.PURCHASER_GROUP_TEL
            ...
            if (this.req.method === 'POST') {
                ...
                form(this.req, this.res, (err) => {
                    if (this.req.form.isValid) {
                        ...
                        reservationModel.paymentMethod = GMOUtil.PAY_TYPE_CVS; // コンビニで固定
                ...
                this.res.locals.tel = '';
                this.res.locals.paymentMethod = GMOUtil.PAY_TYPE_CVS;
                ...
                this.setProcessLogger(reservationModel.paymentNo, () => {
                    ...
                    for (let reservationDocument4update of reservationDocuments4update) {
                        ...
                        promises.push(new Promise((resolve, reject) => {
                            // 予約完了
                            reservationDocument4update['status'] = ReservationUtil.STATUS_WAITING_SETTLEMENT_PAY_DESIGN;
