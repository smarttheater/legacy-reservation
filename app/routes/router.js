...
exports.default = (app) => {
    ...
    app.all('/customer/reserve/:token/payment', base, (req, res, next) => __awaiter(this, void 0, void 0, function* () { yield (new CustomerReserveController_1.default(req, res, next)).payment(); }));
