...
router.get('/ticketinfo', (req: Request, res: Response) => {
    ...
    const url: string = (ticketInfoUrlByLocale[locale] !== undefined) ? ticketInfoUrlByLocale[locale] : ticketInfoUrlByLocale.en;
...
router.get('/aboutenter', (req: Request, res: Response) => {
    const locale: string = (typeof req.getLocale() === 'string' && req.getLocale() !== '') ? req.getLocale() : 'en';
    const url: string = (aboutEnteringUrlByLocale[locale] !== undefined) ? aboutEnteringUrlByLocale[locale] : aboutEnteringUrlByLocale.en;
...
router.get('/privacypolicy', (req: Request, res: Response) => {
    const locale: string = (typeof req.getLocale() === 'string' && req.getLocale() !== '') ? req.getLocale() : 'en';
    const url: string = (privacyPolicyUrlByLocale[locale] !== undefined) ? privacyPolicyUrlByLocale[locale] : privacyPolicyUrlByLocale.en;
...
router.get('/contact', (req: Request, res: Response) => {
    const locale: string = (typeof req.getLocale() === 'string' && req.getLocale() !== '') ? req.getLocale() : 'en';
    const url: string = (contactUrlByLocale[locale] !== undefined) ? contactUrlByLocale[locale] : contactUrlByLocale.en;
...
router.get('/returntop', (req: Request, res: Response) => {
    const locale: string = (typeof req.getLocale() === 'string' && req.getLocale() !== '') ? req.getLocale() : 'en';
    const url: string = (topUrlByLocale[locale] !== undefined) ? topUrlByLocale[locale] : topUrlByLocale.en;
