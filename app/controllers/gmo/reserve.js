...
const reserveCvs_1 = require("./reserveCvs");
 ...
 */
class GMOReserveController extends reserveBase_1.default {
    /**
     * GMO決済を開始する
     */
    start() {
            ...
            if (!_.isEmpty(gmoResultModel.ErrCode)) {
                ...
                switch (gmoResultModel.PayType) {
                    case gmo_service_1.Util.PAY_TYPE_CVS:
                        ...
                        const cvsController = new reserveCvs_1.default(this.req, this.res, this.next);
