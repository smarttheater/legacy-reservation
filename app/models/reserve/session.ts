    ...
    public seatCode2reservationDocument(seatCode: string): ttts.mongoose.Document {
        ...
        if (reservation !== undefined) {
            doc = {
                ...
                purchaser_last_name:
                    (this.transactionInProgress.purchaser !== undefined) ? this.transactionInProgress.purchaser.lastName : '',
                ...
                watcher_name_updated_at:
                    (reservation.watcher_name !== undefined && reservation.watcher_name !== '') ? moment().valueOf() : ''
            };
        }
