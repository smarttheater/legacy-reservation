        ...
        $.ajax({
            ...
            if (data.isSuccess) {
                ...
                $('.table-reservation-confirm').html(
                      '<tr><th>予約番号:</th><td>' + data.reservations[0].payment_no + '</td></tr>'
                    + '<tr><th>タイトル:</th><td>' + data.reservations[0].film_name + '</td></tr>'
                    + '<tr><th>上映時間/場所:</th><td>' + data.reservations[0].performance_day + ' ' + data.reservations[0].performance_start_time + '- ' + data.reservations[0].theater_name + '' + data.reservations[0].screen_name + '</td></tr>'
